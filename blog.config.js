...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '39380ce0ad364047a4931a85e4f817df,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'refs', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Founder of Neotec.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Neotec.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Neotec, refs', // 网站关键词 英文逗号隔开
