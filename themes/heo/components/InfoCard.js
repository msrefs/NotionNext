...
export function InfoCard(props) {
  ...
  return (
    <Card className='wow fadeInUp bg-[#ffffff] dark:bg-stone-850 text-black flex flex-col w-72 overflow-hidden relative'>
      {/* 信息卡牌第一行 */}
...
function MoreButton() {
  ...
  return (
    <Link href={url3}>
      <div
        className={
          'group bg-white dark:bg-yellow-500 hover:bg-white dark:hover:bg-black hover:text-black dark:hover:text-white flex items-center transition-colors duration-200 py-2 px-3 rounded-full space-x-1'
        }>
        <ArrowRightCircle
          className={
