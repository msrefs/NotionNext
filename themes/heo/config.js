const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到Neotec.', url: 'https://neotec.us.kg/message' },
    { title: 'Neotec.创造无限可能', url: 'https://neotec.us.kg/message' }
  ],
  ...
  HEO_HERO_TITLE_2: '<i class="fa-solid fa-list-check"></i>',
  HEO_HERO_TITLE_3: '<div>/<div>',
  HEO_HERO_TITLE_4: '<meta name="user-login" content="msrefs">',
  HEO_HERO_TITLE_5: 'Neotec.创造无限可能',
  HEO_HERO_TITLE_LINK: 'https://neotec.us.kg',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: 'Basic', url: '/tag/Basic' },
  HEO_HERO_CATEGORY_2: { title: 'Popular', url: '/tag/Popular' },
  ...
  HEO_INFO_CARD_URL3: 'https://neotec.us.kg/message',
